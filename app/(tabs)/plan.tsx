    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      {swapFrom && (
        <View className="bg-amber-50 border-b border-amber-200 px-5 py-3 flex-row items-center gap-3">
          ...
          <View className="flex-1">
            <Text className="text-amber-800 text-sm font-semibold">Select a meal to swap with</Text>
            <Text className="text-amber-600 text-xs mt-0.5">Tap any other meal slot • Tap same slot to cancel</Text>
          </View>
          <TouchableOpacity onPress={() => setSwapFrom(null)}
            className="bg-amber-100 px-3 py-1.5 rounded-lg">
            <Text className="text-amber-700 text-xs font-medium">Cancel</Text>
          </TouchableOpacity>
        </View>
      )}
      ...
      >
        ...
        {!swapFrom && (
          <View className="flex-row items-center gap-2 bg-blue-50 border border-blue-100 rounded-xl px-4 py-3 mb-4">
            ...
            <Text className="text-blue-700 text-xs flex-1">
              Tap any meal to select it, then tap another to swap their positions
            </Text>
          </View>
        )}
        ...
        <TouchableOpacity
          ...
          className="mt-3 flex-row items-center justify-between bg-white border border-gray-100 rounded-2xl px-5 py-4"
          style={{ elevation: 1 }}
          activeOpacity={0.7}
        >
          <View className="flex-row items-center gap-3">
